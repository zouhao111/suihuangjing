...
public class Conf_paramService implements Conf_paramManager{
	...
	public List<PageData> list_control(Page page)throws Exception{
		return (List<PageData>)dao.findForList("Conf_paramMapper.datalistPage_control", page);
	}
	/**列表(全部)
	 * @param pd
	 * @throws Exception
	...
	public List<PageData> listAll_pd_other(PageData pd)throws Exception{
		return (List<PageData>)dao.findForList("Conf_paramMapper.listAll_pd_other", pd);
	}
	...
	public List<PageData> listAll_pd_control(PageData pd)throws Exception{
		return (List<PageData>)dao.findForList("Conf_paramMapper.listAll_pd_control", pd);
	}
	/**列表(全部)
	 * @param pd
	 * @throws Exception
	...
	public List<PageData> list_other(Page page) throws Exception {
		return (List<PageData>)dao.findForList("Conf_paramMapper.datalistPage_other", page);
	}
