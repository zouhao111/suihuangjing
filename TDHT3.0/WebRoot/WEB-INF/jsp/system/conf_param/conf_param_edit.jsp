					...
					<form action="conf_param/${msg }.do" name="Form" id="Form" method="post">
						...
						<tr>
							...
							<tr>
								...
								<td><input type="text" name="DATA_TYPES" id="DATA_TYPES" value="${pd.DATA_TYPES}" maxlength="12" placeholder="这里输入数据类型" title="数据类型" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">高低位排序:</td>
								<td><input type="text" name="BYTE_ORDER" id="BYTE_ORDER" value="${pd.BYTE_ORDER}" maxlength="12" placeholder="这里输入高低位排序" title="高低位排序" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">报警上限:</td>
								<td><input type="text" name="LIMITL" id="LIMITL" value="${pd.LIMITL}" maxlength="12" placeholder="这里输入报警上限" title="报警上限" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">时间整形:</td>
