										...
										<div style="float: left;">
											<table>
												<tr>
													...
													<td>&nbsp;地址：</td>
													<td><input type="text" name="dbAddress" id="dbAddress" value="192.168.1.128" maxlength="200" placeholder="数据库连接地址" title="数据库连接地址"/></td>
													<td>&nbsp;端口：</td>
												...
												<tr>
													<td>用户名：</td>
													<td><input type="text" name="username" id="username" value="tdht"  maxlength="32" placeholder="输入用户名" title="用户名"/></td>
													<td>&nbsp;密码：</td>
													<td><input type="password" name="password" id="password"  maxlength="32" placeholder="输入密码" value="tdht"title="密码"/></td>
													<td>&nbsp;库名：</td>
													<td><input type="text" name="databaseName" id="databaseName"  maxlength="32" placeholder="输入数据库名"value="tdht3.0" title="数据库名"/></td>
												</tr>
											</table>
										</div>
