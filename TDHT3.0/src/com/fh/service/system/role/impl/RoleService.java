...
public class RoleService implements RoleManager{
	 ...
	 *//*
	@SuppressWarnings("unchecked")
	public List<PageData> listAllRolesByPIds(Page page) throws Exception {
		return (List<PageData>) dao.findForList("RoleMapper.listAllRolesByPIds", page);
	}*/
	...
	public PageData findMaxId(PageData pd) throws Exception {
		return (PageData) dao.findForObject("RoleMapper.findMaxId", pd);
	}
