					...
					<form action="imgmsg/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								...
								<td><input type="text" name="IMGURL1" id="IMGURL1" value="${pd.IMGURL1}" maxlength="200" placeholder="这里输入图片地址(完整路径)1" title="图片地址1" onmouseover="showTU('IMGURL1','yulantu1');" onmouseout="hideTU('yulantu1');" />
									<div class="yulantu" id="yulantu1"></div>
								</td>
								<td><a class="btn btn-xs btn-info" title="选择" onclick="xuanTp('IMGURL1');">选择 </a></td>
							...
							<tr>
								...
								<td><input type="text" name="IMGURL2" id="IMGURL2" value="${pd.IMGURL2}" maxlength="200" placeholder="这里输入图片地址(完整路径)2" title="图片地址2" onmouseover="showTU('IMGURL2','yulantu2');" onmouseout="hideTU('yulantu2');"  />
									<div class="yulantu" id="yulantu2"></div>
								</td>
								<td><a class="btn btn-xs btn-info" title="选择" onclick="xuanTp('IMGURL2');">选择 </a></td>
							...
							<tr>
								...
								<td><input type="text" name="IMGURL3" id="IMGURL3" value="${pd.IMGURL3}" maxlength="200" placeholder="这里输入图片地址(完整路径)3" title="图片地址3" onmouseover="showTU('IMGURL3','yulantu3');" onmouseout="hideTU('yulantu3');" />
									<div class="yulantu" id="yulantu3"></div>
								</td>
								<td><a class="btn btn-xs btn-info" title="选择" onclick="xuanTp('IMGURL3');">选择 </a></td>
							...
							<tr>
								...
								<td><input type="text" name="IMGURL4" id="IMGURL4" value="${pd.IMGURL4}" maxlength="200" placeholder="这里输入图片地址(完整路径)4" title="图片地址4" onmouseover="showTU('IMGURL4','yulantu4');" onmouseout="hideTU('yulantu4');"  />
									<div class="yulantu" id="yulantu4"></div>
								</td>
								<td><a class="btn btn-xs btn-info" title="选择" onclick="xuanTp('IMGURL4');">选择 </a></td>
							...
							<tr>
								...
								<td><input type="text" name="IMGURL5" id="IMGURL5" value="${pd.IMGURL5}" maxlength="200" placeholder="这里输入图片地址(完整路径)5" title="图片地址5" onmouseover="showTU('IMGURL5','yulantu5');" onmouseout="hideTU('yulantu5');"  />
									<div class="yulantu" id="yulantu5"></div>
								</td>
								<td><a class="btn btn-xs btn-info" title="选择" onclick="xuanTp('IMGURL5');">选择 </a></td>
							...
							<tr>
								...
								<td><input type="text" name="IMGURL6" id="IMGURL6" value="${pd.IMGURL6}" maxlength="200" placeholder="这里输入图片地址(完整路径)6" title="图片地址6" onmouseover="showTU('IMGURL6','yulantu6');" onmouseout="hideTU('yulantu6');"  />
									<div class="yulantu" id="yulantu6"></div>
								</td>
								<td><a class="btn btn-xs btn-info" title="选择" onclick="xuanTp('IMGURL6');">选择 </a></td>
							...
							<tr>
								...
								<td><input type="text" name="IMGURL7" id="IMGURL7" value="${pd.IMGURL7}" maxlength="200" placeholder="这里输入图片地址(完整路径)7" title="图片地址7" onmouseover="showTU('IMGURL7','yulantu7');" onmouseout="hideTU('yulantu7');" />
									<div class="yulantu" id="yulantu7"></div>
								</td>
								<td><a class="btn btn-xs btn-info" title="选择" onclick="xuanTp('IMGURL7');">选择 </a></td>
							...
							<tr>
								...
								<td><input type="text" name="IMGURL8" id="IMGURL8" value="${pd.IMGURL8}" maxlength="200" placeholder="这里输入图片地址(完整路径)8" title="图片地址8" onmouseover="showTU('IMGURL8','yulantu8');" onmouseout="hideTU('yulantu8');"  />
									<div class="yulantu" id="yulantu8"></div>
								</td>
								<td><a class="btn btn-xs btn-info" title="选择" onclick="xuanTp('IMGURL8');">选择 </a></td>
