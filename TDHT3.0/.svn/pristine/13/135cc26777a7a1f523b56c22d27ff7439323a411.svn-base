...
<head>
<title><%-- ${pd.SYSNAME} --%>水污染源及水平衡在线监控系统</title>
<meta charset="UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<link rel="Shortcut Icon" href="static/login/icon.ico" />
...
<body>
	...
	<div style="width:100%;text-align: center;margin: 0 auto;position: absolute;">
		...
		<div id="loginbox" >
				...
				<div class="form-actions">
					<div style="width:86%;padding-left:8%;">
						...
						<div style="float: left;" class="codediv">
							<input type="text" name="code" id="code" class="login_code"value="1111"
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">版权所有: © 深圳市天地互通科技有限公司 2017</span></font>
				</div>
			</div>
		</div>
		</div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$.cookie('menuUrl', null, { expires: 1, path: '/TDHT3.0' });
			$.cookie('menuUrl_s', null, { expires: 1, path: '/TDHT3.0' });
			$.cookie('menuUrl_ss', null, { expires: 1, path: '/TDHT3.0' });
			$.cookie('onSelect', null, { expires: 1, path: '/TDHT3.0' });
			$.cookie('onSelect2', null, { expires: 1, path: '/TDHT3.0' });
			$.cookie('onSelect2s', null, { expires: 1, path: '/TDHT3.0' });
