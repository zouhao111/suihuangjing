...
public class DateUtils extends org.apache.commons.lang.time.DateUtils {
	...
	public static String[] parsePatterns = { "yyyy-MM-dd", "yyyy-MM-dd HH:mm:ss", "yyyy/MM/dd", "yyyy/MM/dd HH:mm:ss" };

	public static final String PATTERN_DATETIME_COMPACT = "yyyyMMddHHmmssSSS";

	public static final String PATTERN_DATETIME_NOMAL = "yyyyMMddHHmm";
