...
public class JsonSerializer {
	 ...
	 */
	private Class<?>[] stringTypes = { String.class, char.class, Character.class, Enum.class, java.util.Date.class,
			java.sql.Date.class };
	/**
	 * 映射为JsonNumber的Java类型
	 */
	private Class<?>[] numberTypes = { int.class, long.class, short.class, float.class, double.class, byte.class,
	...
	JsonAware jsonBooleanMapping(Object src) {
		...
		JsonBoolean target = ((Boolean) src) ? JsonBoolean.getTrueInstance() : JsonBoolean.getFalseInstance();
		return target;
	}
