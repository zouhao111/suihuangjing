...
final class Reflector {
	 ...
	 * 访问权限修饰字段
	 */
	private static final int ACCESS_MODIFIER = Modifier.PUBLIC | Modifier.PROTECTED | Modifier.PRIVATE;
	 ...
	 */
	public static Object getFieldValue(Field field, Object target, boolean forceAccess) throws IllegalAccessException {
		if (field == null) {
