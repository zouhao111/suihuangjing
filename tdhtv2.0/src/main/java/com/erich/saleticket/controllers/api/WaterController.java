	...
	public String qualityFormList(ViewdaliyReport data, HttpServletRequest request, HttpServletResponse response)   {
		...
		if(type!=11){
			...
			for(int i=0;i<datass.size();i++){
				...
				if(datass.get(i).getMinFlu()!=null){
					datass.get(i).setMinFlu(fixed(datass.get(i).getMinFlu(), 3));
					datass.get(i).setMaxFlu(fixed(datass.get(i).getMaxFlu(), 3));
				}else{
					datass.get(i).setMinFlu(0.0);
					datass.get(i).setMaxFlu(0.0);
				}
					
					if(datass.get(i).getMinTurbidity()==null){
						datass.get(i).setMinTurbidity(0.0);
						datass.get(i).setMaxTurbidity(0.0);
					}else{
						datass.get(i).setMinTurbidity(fixed(datass.get(i).getMinTurbidity(), 1));
						datass.get(i).setMaxTurbidity(fixed(datass.get(i).getMaxTurbidity(), 1));
					}
					if(datass.get(i).getMinDo()==null){
						datass.get(i).setMinDo(0.00);
						datass.get(i).setMaxDo(0.00);
					}else{
						datass.get(i).setMinDo(fixed(datass.get(i).getMinDo(), 2));
						datass.get(i).setMaxDo(fixed(datass.get(i).getMaxDo(), 2));
					}
					if(datass.get(i).getMinTemp()==null){
						datass.get(i).setMinTemp(0.00);
						datass.get(i).setMaxTemp(0.00);
					}else{
						datass.get(i).setMinTemp(fixed(datass.get(i).getMinTemp(), 2));
						datass.get(i).setMaxTemp(fixed(datass.get(i).getMaxTemp(), 2));
					}
			...
			for(int i=0;i<datass.size();i++){
				...
				datass.get(i).setRealni(fixed(datass.get(i).getRealni(), 2));
				datass.get(i).setRealcu(fixed(datass.get(i).getRealcu(), 2));
				datass.get(i).setRealFlu(fixed(datass.get(i).getRealFlu(), 3));
				if(datass.get(i).getRealTurbidity()==null){
					datass.get(i).setRealTurbidity(0.0);
				}else{
					datass.get(i).setRealTurbidity(fixed(datass.get(i).getRealTurbidity(), 1));
				}
				if(datass.get(i).getRealDo()==null){
					datass.get(i).setRealDo(0.00);
				}else{
					datass.get(i).setRealDo(fixed(datass.get(i).getRealDo(), 2));
				}
				if(datass.get(i).getRealTemp()==null){
					datass.get(i).setRealTemp(0.00);
				}else{
					datass.get(i).setRealTemp(fixed(datass.get(i).getRealTemp(), 2));
				}
