...
public class BalanceController extends BaseController{
	...
	public String balanceList(Balancea balancea, HttpServletRequest request, HttpServletResponse response)   {
		...
		if(balancea.getRid()==75501330008l){
			balancea.setRid(75501330008l);
		}else if(balancea.getRid()==75501330009l){
			balancea.setRid(75501330009l);
		}else if(balancea.getRid()==75501330010l){
			balancea.setRid(75501330010l);
		}else if(balancea.getRid()==75501330011l){
			balancea.setRid(75501330011l);
		}else if(balancea.getRid()==75501330012l){
			balancea.setRid(75501330012l);
		}else{
			balancea.setRid(75501330008l);
		}
