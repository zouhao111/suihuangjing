...
<![endif]-->
<!--[if  IE 7]>
<link href="${ctx}/resources/newLog/css/ie7.css"	type="text/css" rel="stylesheet" />
<![endif]-->
...
$(function(){
//console.log(${webCompany.companyId})
 ...
 //  console.log(imrid)
    ...
    * 判断rid   左侧导航梯形内显示公司名字
    */ 
   /*  if(imrid==75501330001){
    	   $("#left_img").html("&nbsp;&nbsp;&nbsp;永&nbsp;&nbsp;艺&nbsp;&nbsp;发&nbsp;"); 
       }else if(imrid==75501330002){
    	  $("#left_img").html("&nbsp;&nbsp;&nbsp;欧&nbsp;&nbsp;达&nbsp;&nbsp;可&nbsp;");
       }else if(imrid==75501330003){
    	   	$("#left_img").html("&nbsp;&nbsp;&nbsp;测&nbsp;&nbsp;试&nbsp;&nbsp;一&nbsp;");
       }else if(imrid==75501330004){
    	  $("#left_img").html("中&nbsp;村&nbsp;科&nbsp;技&nbsp; ");
       }else if(imrid==75501330005){
    	 	$("#left_img").html("&nbsp;&nbsp;&nbsp;测&nbsp;试&nbsp;二&nbsp;");
       }  */
...
$(document).click(function(){
 ...
 //alert(winWidth)
  ...
  $("#top").css("min-width",1050)
    $("#top_div").css("min-width",1100)
     $(".content-main").css("min-width",1050)
...
<div >
	<div class="container-top" style=" top:10px;">
		...
		<div class="logo" style="margin-left: 20px;">
			<img src="${ctx}/resources/newMain/img/logo.png" border="0" style="" />
...
<%--<div id="demoDiv2" bg="${ctx}/resources/img/background/b106fca84153.jpg" class="m" style="height:180px;">
  ...
  --%></div>
       ...
       <a  type="hidden" href="${ctx}/admin/tdht/data/areaHtml" id="baoans"  target="main"></a>
		...
		<c:if test="${webCompany.companyId ==1000||webCompany.companyId ==0}">
	...
	<ul class="nav" style="z-index: 999;position: relative;">
     	...
     	<li><a href="${ctx}/admin/tdht/data/areaHtml?area=baoan" target="main">地图定位</a> <img id="chose_img" src="${ctx}/resources/newMain/img/chose.png" style="position: absolute;display: none"><img id="chose_img2" class="chose_img2_2"src="${ctx}/resources/newMain/img/chose.png" style="position: absolute;display: none"></li>  
    	<li ><a  target="main">监测数据 <img id="pull-down"src="${ctx}/resources/newMain/img/pull-down2.png" ></a>  <img id="chose_img" src="${ctx}/resources/newMain/img/chose.png" style="position: absolute;display: none"><img id="chose_img2" src="${ctx}/resources/newMain/img/chose.png" style="position: absolute;display: none">
         ...
         <ul style="width: 320px;height:185px;background-color: #00B9EF;position:absolute; ">
            
          <li style="margin-left: 10px"> <img id="dot"src="${ctx}/resources/newMain/img/dot2.png"  class="dot"><a id="data2" name="webUrl" href="" target="main">实时数据</a></li>  
          <li><img id="dot" src="${ctx}/resources/newMain/img/dot2.png" class="dot2" ><a target="main">历史数据</a> <img id="pull-down2"src="${ctx}/resources/newMain/img/pull-down.png" > 
            <ul>
     ...
     <li><a target="main">图形曲线 <img id="pull-down"src="${ctx}/resources/newMain/img/pull-down2.png" ></a> <img id="chose_img" src="${ctx}/resources/newMain/img/chose.png" style="position: absolute;display: none"><img id="chose_img2" src="${ctx}/resources/newMain/img/chose.png" style="position: absolute;display: none">
 ...
 <li><img id="dot2" src="${ctx}/resources/newMain/img/dot2.png"  class="dot2"><a id="data8"href="" target="main">工业排水</a></li><%--  
     ...
     <c:if test="${webCompany.companyId >=500&&webCompany.companyId <2000||webCompany.companyId==0}">
     <li><a  target="main">设备管理 <img id="pull-down"src="${ctx}/resources/newMain/img/pull-down2.png" ></a> <img id="chose_img" src="${ctx}/resources/newMain/img/chose.png" style="position: absolute;display: none"><img id="chose_img2" src="${ctx}/resources/newMain/img/chose.png" style="position: absolute;display: none">
         <ul id="log_mun" style="width: 14.19%;height:200px;background-color: #00B9EF;position:absolute; ">
          <li><img  id="dot" src="${ctx}/resources/newMain/img/dot2.png"  style="left: 30px;"class="dot"><a id="data14" href="" target="main">设备状态</a></li>  
         
          
          <li><img id="dot" src="${ctx}/resources/newMain/img/dot2.png" style="left: 30px;" class="dot"><a id="data15" href="" target="main">设备控制</a></li>
          <li><img id="dot" src="${ctx}/resources/newMain/img/dot2.png" style="left: 30px;" class="dot"><a id="data18" href="" target="main">操作日志</a></li>
      
          <li><img id="dot" src="${ctx}/resources/newMain/img/dot2.png" style="left: 30px;" class="dot"><a id="data19" href="" target="main">设备日志</a></li>
         </ul> 
     </li>  
     </c:if>
     
     <li><a id="data_video"href="" target="main">视频</a> <img id="chose_img" src="${ctx}/resources/newMain/img/chose.png" style="position: absolute;display: none"><img id="chose_img2" src="${ctx}/resources/newMain/img/chose.png" style="position: absolute;display: none"></li>
   ...
   <%--  <li><a href="${ctx}/admin/sys/sysMenu/menuList" target="main">系统管理</a></li> 
	...
	<!--左侧树形菜单 -->
		...
		<li><a id="company_2" href="" target="main">XX公司</a></li>
      	...
      	<div class="htmleaf-content bgcolor-3" style="height:90% ;background-color:#fff; border-top:1px solid white;border-bottom:1px solid white;padding-top: 0px;">
			<!-- This is mtree list -->
			<ul class=mtree style="height:100% ;background-color:#fff">
			  <li><a href="#" class="city"><img id="dot" src="${ctx}/resources/newMain/img/dot.png"  class="dot_img">深圳市</a>
			    <ul>
			      <li><a id="baoan" href=""><img id="dot2" src="${ctx}/resources/newMain/img/dot.png"  class="dot_img2"  >宝安区</a>
			       ...
			       <li><a href="#"><img id="dot2" src="${ctx}/resources/newMain/img/dot.png"  class="dot_img2"  >光明区</a>
			      <ul>
			           <c:forEach items="${company}" var="bean">
			           <c:if test="${bean.areaId==6}">
			           <li><a id="yyf"href="#"value="${bean.rid}"onclick='clickCom(${bean.rid})' ><img id="dot3" src="${ctx}/resources/newMain/img/dot.png" class="dot_img3"   >${bean.companyName}</a><a id="yyf1"href="" style="display: none;" target="main" ></a></li>
			           </c:if>
			           </c:forEach>
			           </ul>
      		...
      		<div id="img_div"style="cursor:pointer; width: 30px;height: 100%;position: absolute;top: 150px;left: 140px;" ><div class="left_img"><div id="left_img"class="left_img1"></div></div>
