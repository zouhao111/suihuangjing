...
<body>
	...
	<div style="display: none;">
		<div class="search-bar" style="padding: 5px 0;">
			...
			style="margin-left: -8; width: 1000px;" class="gray">
				<tr>
					<td><label for="keywords">姓名/帐号：<input id="keywords"
							name="keywords" type="text" class="text" style="width: 269px;"
							title="两个以上用；分隔" /></label></td>
					<td><label for="starttime"> 创建时间：从：</label><input
						id="starttime" name="starttime" type="text" class="text"
						style="width: 218px;" value="" readonly="true" />&nbsp;到：<input
						id="endtime" name="endtime" type="text" class="text"
						style="width: 218px;" value="" readonly="true" /></td>
					<td rowspan="2"><input name="search" class="btn-big"
						id="search" type="button" value="搜索" /></td>
				</tr>
				<tr>
					<td><select style="width: 160px;" name="gender" id="gender">
					...
					<td><select style="width: 175px;" name="groups" id="groups">
							<option value="">所属群组</option>
							<option value="e82a814b9a6cb21c">全体经理</option>
							...
							<option value="7bdbth6vg">&nbsp;├仓管部</option>
							<option value="9ao9ostb">&nbsp;├资源管理部</option>
							<option value="pt329p3r">&nbsp;├产品部</option>
							<option value="1nq61t80r">&nbsp;├财务部</option>
							<option value="1rv84vp43">&nbsp;├行政部</option>
							<option value="30jm9iseh">&nbsp;├总经办</option>
							<option value="39kd0k3mg">&nbsp;├市场部</option>
							<option value="5ns08t0j0">&nbsp;├网管部</option>
							<option value="63775ses9">&nbsp;├研发部</option>
							<option value="7242k9hg0">&nbsp;├采购部</option>
							<option value="8a99qrbh3">&nbsp;├客服部</option>
							<option value="8incgd0eu">&nbsp;└销售部</option>
							<option value="7962kt9i9">&nbsp;&nbsp;└A组</option>
					</select></td>
				</tr>
			</table>
		</div>
