...
<div class="title-bar"><strong class="f14 text-title">添加用户信息</strong> | <a href="#" onclick="back()">返回</a></div>
<form id="myform" name="myform" method="post">
    <table id="user-base" border="0" cellspacing="2" cellpadding="3" class="table-form table-form-f12" style="margin-top:20px;">
        ...
        <tr>
            ...
            <td><input name="realName" type="text" class="text" id="realName" value="" style="width:250px" /></td>
        </tr>
        <tr>
            <th align="right"><label for="name">登录账户[*]：</label></th>
            <td><input name="account" type="text" class="text" id="account" value="" style="width:250px" /></td>
        </tr>
        <tr>
            <th align="right"><label for="password">登录密码[*]：</label></th>
            <td><input name="password" type="password" class="text" id="password" value="" style="width:250px" /></td>
        </tr>
        <tr>
            <th align="right">性别[*]：</th>
            <td><select name="gender" style="width:250px;"><option value="1" selected="selected">男</option><option value="0">女</option></select></td>
        </tr>
        <tr>
            <th align="right"><label for="name">手机：</label></th>
            <td><input name="mobile" type="text" class="text" id="mobile" value="" style="width:250px" /></td>
        </tr>
        <tr>
            <th align="right"><label for="name">电子邮件：</label></th>
            <td><input name="email" type="text" class="text" id="email" value="" style="width:250px" /></td>
        </tr>
        <tr>
            <th align="right"><label for="name">选项[*]：</label></th>
            <td>
            	<input type="checkbox" id="enabled" name="enabled" value="1" checked="checked" >有效
            </td>
        </tr>
        <tr>
