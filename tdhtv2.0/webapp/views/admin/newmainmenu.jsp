...
<div id="top_top"style="height:80px;">
	
		<!-- LOGO -->
		<div class="logo"style="height:80px;width:350px ;float:left;position: absolute;top:20px;">
...
<%--<div id="demoDiv2" bg="${ctx}/resources/img/background/b106fca84153.jpg" class="m" style="height:180px;">
  ...
  --%>
	...
	<div id="top" style="height:38px;position:absolute ;top:23px;left:50%; margin-left:-500px; width:1100px;"class="container">
	<ul class="nav" style="z-index: 999;position: relative;">
    	...
    	<li><a  target="main">监测数据</a>
         <ul>
          ...
          <li><a target="main">历史数据</a></li>
             
                 <li><a id="data3"href="" target="main">日结报表</a></li>
                 <li><a id="data4"href="" target="main">历史报表</a></li>
                 <li><a id="data5"href="" target="main">水平衡分析</a></li>
                 <li><a id="data55"href="" target="main">污染物汇总</a>   </li>          
         ...
         <ul>  
          <li><a  target="main">监测曲线</a>  
             <ul>  
                 ...
                 <li><a id="data8"href="" target="main">工业排水</a></li><%--  
		     ...
		     <div class="theme-popbod dform">
		           <form class="theme-signin" id="loginform"  name="loginform" action="" method="post">
		                <ol>
		                     ...
		                     <li><strong>内容：</strong><textarea rows="30" cols="40" id="content" name="content" class="ipt" style="width:400px;height:200px;" ></textarea></li>
