...
<script type="text/javascript">
	...
	//查询
	function findReport(){
		document.myform.action = "../alarmWater/historyList";
...
<body class="body_overflow">
	...
	<c:choose>
		...
		<div style="background-color:#ffffff;width:100%;height:5px;"></div>
			<form action="../alarmWater/historyList?rid=${rid}&type=1 " id="myform" name="myform" method="post">
		...
		<input id="select" type="hidden" value="${waterType}" >
			<div style="background-color:#ffffff;width:100%;height:5px;"></div>
			<form action="../alarmWater/historyList?rid=${rid}&type=3 " id="myform" name="myform" method="post">
	 ...
	 <select id="waterType"name="waterType"> 
		...
		<input id="select" type="hidden" value="${waterType}" >
			<div style="background-color:#ffffff;width:100%;height:5px;"></div>
			<form action="../alarmWater/historyList?rid=${rid}&type=6" id="myform" name="myform" method="post">
	  ...
	  <span class="heard_font14">污染物类型：</span>
		...
		<input id="select" type="hidden" value="${waterType}" >
			<div style="background-color:#ffffff;width:100%;height:5px;"></div>
			<form action="../alarmWater/historyList?rid=${rid}&type=5 " id="myform" name="myform" method="post">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-list" id="table" >
		...
		<c:forEach items="${historys}" var="bean">
			<tr   class="tb_font15">
				...
				<td align="center" width="100"><fmt:formatNumber type='number' value='${bean.limitHH}' pattern="0.00"/></td>
				<c:choose>
				...
				<td align="center" width="100" style="background-color: red;"><fmt:formatNumber type='number' value='${bean.value}' pattern="0.00"/></td>
			</tr>
		</c:forEach>
		</tbody>
	</table>
	...
	<div id="pagelist">
		<ul style="list-style:none;">
			...
			export="currentPageNumber=pageNumber" maxPageItems="${pager.pageSize }" maxIndexPages="5" url="../alarmWater/historyList" >
			<!-- 分页带查询条件 -->
