	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-list" id="table" >
		...
		<c:choose>
			...
			<tr  class="tb_font15">
				...
				<td width="100" align="center"><fmt:formatNumber type='number' value='${bean.limitHH}' pattern="0.00"/></td>
				<c:choose>
				...
				<td width="100" align="center" style="background-color: red;"><fmt:formatNumber type='number' value='${bean.value}' pattern="0.00"/></td>
			</tr>
			</c:when></c:choose>
		</c:forEach>
		</tbody>
