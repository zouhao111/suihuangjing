...
<input id="type" type="hidden" value="${type}" >	
	...
	<table border="0" cellspacing="0" cellpadding="0" class="table-list" id="table"   >
			<thead >
					    ...
					    <td id="td_id" align="center" colspan="27"  >工业排水</td>
					 </tr>
						 <tr  class="tb_heard_font15">
						 <c:forEach items="${data_name}" var="bean">
	   ...
	   <c:choose>
		...
		<c:forEach items="${datass}" var="bean">
		 ...
		 <tr    class="tb_font15"   >
			...
			<td  align="center"><fmt:formatNumber type='number' value='${bean.tabTurbidity}' pattern="0.00"/></td>
			<td  align="center"><fmt:formatNumber type='number' value='${bean.tabNH4}' pattern="0.00"/></td>
			<td  align="center"><fmt:formatNumber type='number' value='${bean.tabCr6}' pattern="0.00"/></td>
			<td  align="center"><fmt:formatNumber type='number' value='${bean.tabph}' pattern="0.00"/></td>
			<td  align="center"><fmt:formatNumber type='number' value='${bean.tabconductivity}' pattern="0.0000"/></td>
			 <td  align="center"><fmt:formatNumber type='number' value='${bean.tabDo}' pattern="0.0000"/></td>
			 <td  align="center"><fmt:formatNumber type='number' value='${bean.tabCOD}' pattern="0.00"/></td>
		    <td  align="center"><fmt:formatNumber type='number' value='${bean.tabtemp}' pattern="0.00"/></td>
			<td  align="center"><fmt:formatNumber type='number' value='${bean.tabTP}' pattern="0.00"/></td>
		    <td  align="center"><fmt:formatNumber type='number' value='${bean.tabTN}' pattern="0.00"/></td>
		    
		    <td  align="center"><fmt:formatNumber type='number' value='${bean.tabNO3}' pattern="0.0000"/></td>
		   <td  align="center"><fmt:formatNumber type='number' value='${bean.tabAn}' pattern="0.0000"/></td>
		   
		    <td  align="center"><fmt:formatNumber type='number' value='${bean.tabPhe}' pattern="0.00"/></td>
		    <td  align="center"><fmt:formatNumber type='number' value='${bean.tabCN}' pattern="0.00"/></td>
		    
		    <td  align="center"><fmt:formatNumber type='number' value='${bean.tabPb}' pattern="0.00"/></td>
		    
		    <td  align="center"><fmt:formatNumber type='number' value='${bean.tabCd}' pattern="0.00"/></td>
		    <td  align="center"><fmt:formatNumber type='number' value='${bean.tabCu}' pattern="0.00"/></td>
		    <td  align="center"><fmt:formatNumber type='number' value='${bean.tabHg}' pattern="0.0000"/></td>
		   <td  align="center"><fmt:formatNumber type='number' value='${bean.tabAs}' pattern="0.0000"/></td>
		    <td  align="center"><fmt:formatNumber type='number' value='${bean.tabFe}' pattern="0.00"/></td>
		    
		    <td  align="center"><fmt:formatNumber type='number' value='${bean.tabMn}' pattern="0.00"/></td>
		    
		    <td  align="center"><fmt:formatNumber type='number' value='${bean.tabNi}' pattern="0.00"/></td>
		    <td  align="center"><fmt:formatNumber type='number' value='${bean.tabF}' pattern="0.00"/></td>
		    <td  align="center"><fmt:formatNumber type='number' value='${bean.tabS}' pattern="0.0000"/></td>
		   <td  align="center"><fmt:formatNumber type='number' value='${bean.tabPoison}' pattern="0.0000"/></td>
		    <td  align="center"><fmt:formatNumber type='number' value='${bean.tabOC}' pattern="0.00"/></td>
		    <td  align="center"><fmt:formatNumber type='number' value='${bean.tabZn}' pattern="0.00"/></td>
		  </tr>
