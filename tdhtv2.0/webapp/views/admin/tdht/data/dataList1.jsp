...
<body style="overflow-x:hidden;">
	...
	<div id="click_fou"  style="cursor:pointer;"><p class="f14style"><img id="img_fou"src="${ctx}/resources/img/plus.png"><span class="f14 text-title" >水平衡分析  单位(m<sup>3</sup>)</span></p></div>
	...
	<div id="click_five"  style="cursor:pointer;"><p class="f14style"><img id="img_five"src="${ctx}/resources/img/plus.png"><span class="f14 text-title" >污染物排放总量  </span></p></div>
