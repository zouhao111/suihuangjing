...
<body class="body_overflow">
	...
	<p class="f14style" style="height:25px"><span class="f14 text-title" style="font-size:19px ">${companyconfig.companyName}流量实时数据</span>
	
	<%-- <a style="float:right;font-size: 15px"href="../data/dataNew?rid=${rid}"><img id="img_first" style="margin-right: 50px;border: 0px;"src="${ctx}/resources/newData/img/back.png"><span style="position: absolute;right: 20px;top: 23px;font-size: 19px;color:#0071BC;">返回</span></a>
 --%>
	</p>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-list" id="table" >
	 <c:choose>
	   <c:when test="${IndrainageNum==1&&InsupplyNum==1&&LivsupplyNum==null}">
	   <thead>
					<tr >
	   ...
	   <c:when test="${IndrainageNum==1&&InsupplyNum==1&&LivsupplyNum==1}">
			...
			<thead>
					<tr >
						...
						<th width="21%" style="font-family: 微软雅黑;font-size: 16px;">工业给水1<img id="is_key" style="cursor: pointer;" src="${ctx}/resources/img/key.png" title=""height="20px"/></th>
						<th width="21%" style="font-family: 微软雅黑;font-size: 16px;">工业给水2<img id="ls_key" style="cursor: pointer;"src="${ctx}/resources/img/key.png" title=""  height="20px"/></th>
						<th width="21%" style="font-family: 微软雅黑;font-size: 16px;">工业排水 <img id="id_key"style="cursor: pointer;" src="${ctx}/resources/img/key.png"  title=""  height="20px"/></th>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-list" id="table" >
			<thead>
					...
					<c:if test="${rid==75501330025}">
						...
						<th width="11%" style="font-family: 微软雅黑;font-size: 16px;">工业给水1</th>
						<th width="11%" style="font-family: 微软雅黑;font-size: 16px;">工业给水2</th>
