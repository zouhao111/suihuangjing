	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-list" id="table" style="border-collapse:collapse;" >
		...
		<c:forEach items="${alarms}" var="bean">
			...
			<tr   class="tb_font15">
				...
				<td width="100" align="center"><fmt:formatNumber type='number' value='${bean.max_early}' /></td>
				<c:choose>
				...
				<td width="100" align="center" style="background-color: yellow;"><fmt:formatNumber type='number' value='${bean.realValue }' /></td>
			</tr>
			</c:when></c:choose>
		</c:forEach>
		</tbody>
